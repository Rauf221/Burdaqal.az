				...
				<div>
						...
						<form className="form-additional flex gap30 flex-column">
							<div className="cols cols-two">
								<fieldset className="text">
									<input type="text" placeholder="Property ID" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
								<select className="nice-select" tabIndex={0}>
							...
							<div className="cols cols-two">
								...
								<fieldset className="text">
									<input type="text" placeholder="Label" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
							</div>
							<div className="cols cols-two">
								<fieldset className="text">
									<input type="text" placeholder="Material" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
								<select className="nice-select" tabIndex={0}>
							...
							<div className="cols cols-two">
								<fieldset className="text">
									<input type="text" placeholder="Home area (sqft)" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
								<fieldset className="text">
									<input type="text" placeholder="Lot dimensions" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
							</div>
							<div className="cols cols-two">
								<fieldset className="text">
									<input type="text" placeholder="Lot area (sqft)" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
								<div />
							</div>
							<div className="button-submit mt-10">
					...
					<div className="wg-box pl-44 mb-20">
						...
						<form className="form-energy flex gap30 flex-column">
							<div className="cols">
								...
								<fieldset className="text">
									<input type="text" placeholder="Energy Index in kWh/m2a" name="text" tabIndex={2} aria-required="true" required />
								</fieldset>
							</div>
							<div className="button-submit mt-10">
								<button className="tf-button-primary" type="submit">Save &amp; Preview<i className="icon-arrow-right-add" /></button>
					...
					<div className="wg-box pl-44 mb-20">
						...
						<form className="form-media">
							...
							<fieldset className="description has-top-title">
								<textarea name="description" rows={4} placeholder="Virtual Tour" tabIndex={2} aria-required="true" required defaultValue={"Lorem Ipsum Dolar Sit Amet"} />
