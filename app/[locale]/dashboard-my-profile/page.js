						...
						<div className="my-profiles-wrap">
							...
							<form className="form-profiles flex gap30 flex-column">
								...
								<fieldset className="description has-top-title">
									<textarea name="description" rows={4} placeholder="Description" tabIndex={2} aria-required="true" required defaultValue={"Lorem Ipsum Dolar Sit Amet"} />
									<label htmlFor>Description</label>
								</fieldset>
								<div className="cols">
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Job" name="text" tabIndex={2} aria-required="true" required />
										<label htmlFor>Job</label>
									</fieldset>
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Web" name="text" tabIndex={2} aria-required="true" required />
								...
								<div className="cols">
									...
									<fieldset className="fax has-top-title">
										<input type="number" placeholder="Fax" name="number" tabIndex={2} aria-required="true" required />
					...
					<div className="wg-box pl-44 mb-20">
						...
						<div className="my-social-media">
							<form className="form-social-media flex gap30 flex-column">
								<div className="cols">
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Facebook Url" name="text" tabIndex={2} aria-required="true" required />
										<label htmlFor>Facebook Url</label>
									</fieldset>
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Twitter Url" name="text" tabIndex={2} aria-required="true" required />
										<label htmlFor>Twitter Url</label>
									</fieldset>
								</div>
								<div className="cols">
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Instagram Url" name="text" tabIndex={2} aria-required="true" required />
										<label htmlFor>Instagram Url</label>
									</fieldset>
									<fieldset className="text has-top-title">
										<input type="text" placeholder="Linkedin Url" name="text" tabIndex={2} aria-required="true" required />
						...
						<div className="my-change-password">
							<form className="form-change-password flex gap30 flex-column">
								<fieldset className="password has-top-title">
									<input type="password" placeholder="Old Password" name="password" tabIndex={0} aria-required="true" required />
									<label htmlFor>Old Password</label>
								</fieldset>
								<div className="cols">
									<fieldset className="password has-top-title">
										<input type="password" placeholder="New Password" name="password" tabIndex={0} aria-required="true" required />
										<label htmlFor>New Password</label>
									</fieldset>
									<fieldset className="password has-top-title">
										<input type="password" placeholder="Confirm New Password" name="password" tabIndex={0} aria-required="true" required />
