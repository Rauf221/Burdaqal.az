				...
				<div className="blog-single-wrap">
							...
							<div className="col-xl-8 col-12">
								<div className="blog-single-inner">
									<ul className="breadcrumbs style-1 justify-start mb-20">
										...
										<li>/</li>
										<li><Link href={BLOG_LIST}>Blog</Link></li>
										<li>/</li>
										<li>{title}</li>
									</ul>
									<div>
					...
					<div className="wg-related-posts">
						<div className="themesflat-container">
							...
							<div className="row">
								{BLOG_LIST_POSTS.slice(0, 4).map((post, i) => (
									<div key={post.slug} className="col-xl-3 col-lg-6 col-12">
										<div className="wg-blog wow fadeInUp" {...(i ? { 'data-wow-delay': `${i * 0.1}s` } : {})}>
											<div className="image">
